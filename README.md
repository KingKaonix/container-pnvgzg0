...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pnvgzg0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pnvgzg0.containers.anotherwebservice.com/
...
```
git clone git@github.com:KingKaonix/container-pnvgzg0.git
cd container-pnvgzg0
```
...
```
docker attach container-pnvgzg0
```
